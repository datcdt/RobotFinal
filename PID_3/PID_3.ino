...
const int PIN_L_IN1 = 29;
const int PIN_L_IN2 = 31;
const int PIN_L_PWM = 5;
const int PIN_L_ENCOD_A_MOTOR = 3;               //A channel for encoder of left motor
const int PIN_L_ENCOD_B_MOTOR = 17;               //B channel for encoder of left motor

const int PIN_R_IN1 = 23;
const int PIN_R_IN2 = 25;
const int PIN_R_PWM = 4;
const int PIN_R_ENCOD_A_MOTOR = 2;              //A channel for encoder of right motor
const int PIN_R_ENCOD_B_MOTOR = 16;              //B channel for encoder of right motor
...
double speed_cmd_left = 0;                    //Vận tốc bánh trái cần thiết(command), m/s
...
// PID Parameters
const double PID_left_param[] = { 0.29167, 189.8799, 0.0 }; //Respectively Kp, Ki and Kd for left motor PID
const double PID_right_param[] = { 0.16331, 258.733, 0.0 }; //Respectively Kp, Ki and Kd for right motor PID

volatile float pos_left = 0;       //Left motor encoder position
volatile float pos_right = 0;      //Right motor encoder position

// PID myPID(&input, &Output, &Setpoint, Kp, Ki, Kd, DIRECT/REVERVE)
